    ...
    const UI = {
        ...
        styles() {
            ...
            ${p}{
              ...
              background:rgba(21,24,28,.96);backdrop-filter:blur(14px) saturate(150%);-webkit-backdrop-filter:blur(14px) saturate(150%);
            ...
            ${p} .tem-header{display:flex;align-items:center;gap:var(--space-4);padding:var(--space-5) var(--space-6);cursor:grab;user-select:none;border-bottom:1px solid var(--border);flex:0 0 auto}
            ${p} .tem-header:active{cursor:grabbing}
            ${p} .tem-badge{flex:0 0 auto;width:38px;height:38px;border-radius:var(--radius-md);display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,#7856ff,var(--acc));color:#fff;box-shadow:0 4px 12px rgba(120,86,255,.4)}
            ${p} .tem-badge svg{display:block}
            ${p} .tem-htext{flex:1 1 auto;min-width:0}
            ${p} .tem-htext h2{margin:0;font-size:15px;font-weight:800;letter-spacing:-.2px;line-height:1.25;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
            ...
            ${p} .tem-body{padding:var(--space-6);overflow-y:auto;flex:1 1 auto;scrollbar-width:thin;scrollbar-color:rgba(255,255,255,.25) transparent}
            ...
            @media (max-width:480px){
              ${p}{top:8px;right:8px;left:8px;width:auto;border-radius:16px}
