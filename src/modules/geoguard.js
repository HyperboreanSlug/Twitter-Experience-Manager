 ...
 */
    const GeoGuard = {
        ...
        /**
         * Region catalog: tier → category → subcategories with location needles.
         * Matches self-reported profile text only. South Africa is intentionally excluded.
         * Tier 1 default ON · Tier 2 default ON · Tier 3 default OFF.
         */
        regionCatalog: [
            {
                id: 'south_asia', tier: 1, tierLabel: 'Tier 1 — Core',
                label: 'South Asia', defaultOn: true,
                subs: [
                    {
                        id: 'india', label: 'India', defaultOn: true, scripts: ['devanagari'],
                        needles: [
                            ...
                            'varanasi', 'agra', 'goa', 'kerala', 'tamil nadu', 'tamilnadu', 'karnataka', 'maharashtra',
                            'gujarat', 'rajasthan', 'west bengal', 'uttar pradesh', 'bihar', 'odisha', 'orissa',
                            'telangana', 'andhra', 'assam', 'jharkhand', 'chhattisgarh', 'madhya pradesh',
                            'haryana', 'uttarakhand', 'himachal', 'jammu', 'kashmir', 'desi'
                        ]
                    },
                    {
                        id: 'pakistan', label: 'Pakistan', defaultOn: true,
                        needles: [
                            'pakistan', 'karachi', 'lahore', 'islamabad', 'rawalpindi', 'peshawar', 'multan',
                            'faisalabad', 'quetta', 'sialkot', 'hyderabad, pakistan'
                        ]
                    },
                    {
                        id: 'bangladesh', label: 'Bangladesh', defaultOn: true,
                        needles: ['bangladesh', 'dhaka', 'chittagong', 'chattogram', 'sylhet', 'khulna', 'rajshahi']
                    },
                    {
                        id: 'sri_lanka', label: 'Sri Lanka', defaultOn: true,
                        needles: ['sri lanka', 'srilanka', 'colombo', 'kandy', 'galle', 'jaffna']
                    },
                    {
                        id: 'nepal', label: 'Nepal', defaultOn: true, scripts: ['devanagari'],
                        needles: ['nepal', 'kathmandu', 'pokhara', 'lalitpur']
                    },
                    {
                        id: 'afghanistan', label: 'Afghanistan', defaultOn: true,
                        needles: ['afghanistan', 'kabul', 'kandahar', 'herat', 'mazar']
                    },
                    {
                        id: 'sa_other', label: 'Other (Bhutan, Maldives, regional)', defaultOn: true,
                        needles: ['bhutan', 'thimphu', 'maldives', 'male, maldives', 'south asia', 'southasian']
                    }
                ]
            },
            {
                id: 'west_africa', tier: 2, tierLabel: 'Tier 2 — High',
                label: 'West Africa', defaultOn: true,
                subs: [
                    {
                        id: 'nigeria', label: 'Nigeria', defaultOn: true,
                        needles: [
                            'nigeria', 'lagos', 'abuja', 'ibadan', 'kano', 'port harcourt', 'benin city',
                            'enugu', 'kaduna', 'abeokuta', 'ibadan', 'naija', 'yoruba', 'igbo'
                        ]
                    },
                    {
                        id: 'ghana', label: 'Ghana', defaultOn: true,
                        needles: ['ghana', 'accra', 'kumasi', 'tamale', 'takoradi']
                    },
                    {
                        id: 'wa_other', label: 'Other West Africa', defaultOn: true,
                        needles: [
                            'senegal', 'dakar', 'ivory coast', "côte d'ivoire", 'cote divoire', 'abidjan',
                            'cameroon', 'douala', 'yaounde', 'yaoundé', 'mali', 'bamako', 'niger', 'niamey',
                            'burkina', 'ouagadougou', 'togo', 'lome', 'benin', 'cotonou', 'liberia', 'monrovia',
                            'sierra leone', 'freetown', 'gambia', 'banjul', 'guinea', 'conakry'
                        ]
                    }
                ]
            },
            {
                id: 'east_africa', tier: 2, tierLabel: 'Tier 2 — High',
                label: 'East Africa (excl. South Africa)', defaultOn: true,
                subs: [
                    {
                        id: 'kenya', label: 'Kenya', defaultOn: true,
                        needles: ['kenya', 'nairobi', 'mombasa', 'kisumu', 'nakuru']
                    },
                    {
                        id: 'uganda_tz', label: 'Uganda / Tanzania', defaultOn: true,
                        needles: ['uganda', 'kampala', 'tanzania', 'dar es salaam', 'dodoma', 'arusha', 'zanzibar']
                    },
                    {
                        id: 'horn', label: 'Horn of Africa', defaultOn: true,
                        needles: [
                            'ethiopia', 'addis ababa', 'addis', 'eritrea', 'asmara', 'somalia', 'mogadishu',
                            'djibouti', 'somaliland', 'hargeisa'
                        ]
                    },
                    {
                        id: 'ea_other', label: 'Other East / Central Africa', defaultOn: true,
                        needles: [
                            'rwanda', 'kigali', 'burundi', 'bujumbura', 'congo', 'kinshasa', 'lubumbashi',
                            'drc', 'zambia', 'lusaka', 'malawi', 'lilongwe', 'mozambique', 'maputo',
                            'sudan', 'khartoum', 'south sudan', 'juba', 'zimbabwe', 'harare', 'angola', 'luanda'
                        ]
                    }
                ]
            },
            {
                id: 'se_asia', tier: 2, tierLabel: 'Tier 2 — High',
                label: 'Southeast Asia', defaultOn: true,
                subs: [
                    {
                        id: 'philippines', label: 'Philippines', defaultOn: true,
                        needles: [
                            'philippines', 'manila', 'quezon city', 'cebu', 'davao', 'makati', 'pasig',
                            'taguig', 'filipino', 'pinoy', 'pinay'
                        ]
                    },
                    {
                        id: 'indonesia', label: 'Indonesia', defaultOn: true,
                        needles: [
                            'indonesia', 'jakarta', 'surabaya', 'bandung', 'medan', 'bekasi', 'tangerang',
                            'bali', 'denpasar', 'yogyakarta'
                        ]
                    },
                    {
                        id: 'vietnam', label: 'Vietnam', defaultOn: true,
                        needles: ['vietnam', 'viet nam', 'hanoi', 'ho chi minh', 'saigon', 'da nang', 'haiphong']
                    },
                    {
                        id: 'sea_other', label: 'Other SEA', defaultOn: false,
                        needles: [
                            'thailand', 'bangkok', 'chiang mai', 'cambodia', 'phnom penh', 'laos', 'vientiane',
                            'myanmar', 'burma', 'yangon', 'rangoon', 'malaysia', 'kuala lumpur', 'johor',
                            'brunei'
                        ]
                    }
                ]
            ...
            {
                id: 'mena', tier: 3, tierLabel: 'Tier 3 — Optional',
                label: 'Middle East / North Africa', defaultOn: false,
                subs: [
                    {
                        id: 'egypt', label: 'Egypt', defaultOn: false,
                        needles: ['egypt', 'cairo', 'alexandria', 'giza']
                    },
                    {
                        id: 'maghreb', label: 'Maghreb', defaultOn: false,
                        needles: [
                            'morocco', 'casablanca', 'rabat', 'marrakech', 'algeria', 'algiers',
                            'tunisia', 'tunis', 'libya', 'tripoli'
                        ]
                    },
                    {
                        id: 'levant_gulf', label: 'Levant / Gulf (broad)', defaultOn: false,
                        needles: [
                            'iraq', 'baghdad', 'basra', 'syria', 'damascus', 'yemen', 'sanaa',
                            'jordan', 'amman', 'lebanon', 'beirut', 'palestine', 'gaza', 'ramallah'
                        ]
                    }
                ]
            },
            {
                id: 'latam', tier: 3, tierLabel: 'Tier 3 — Optional',
                label: 'Latin America (engagement-farm hotspots)', defaultOn: false,
                subs: [
                    {
                        id: 'brazil', label: 'Brazil', defaultOn: false,
                        needles: ['brazil', 'brasil', 'são paulo', 'sao paulo', 'rio de janeiro', 'brasília', 'brasilia']
                    },
                    {
                        id: 'latam_other', label: 'Other LatAm', defaultOn: false,
                        needles: [
                            'venezuela', 'caracas', 'colombia', 'bogota', 'bogotá', 'peru', 'lima',
                            'ecuador', 'quito', 'bolivia', 'la paz', 'paraguay', 'asuncion',
                            'honduras', 'tegucigalpa', 'guatemala', 'el salvador', 'nicaragua'
                        ]
                    }
                ]
            }
        ...
        // Never match these (esp. South Africa vs broader Africa needles)
        regionExcludes: [
            'south africa', 'southafrica', 's. africa', 's africa', 'rsa',
            'cape town', 'capetown', 'johannesburg', 'joburg', 'jozi', 'pretoria', 'durban',
            'soweto', 'gauteng', 'western cape', 'eastern cape', 'kwazulu', 'bloemfontein',
            'port elizabeth', 'gqeberha', 'sandton', 'stellenbosch', 'centurion'
        ],
        ...
        render() {
            ...
            const customNeedles = (Core.store.get('geoCustomNeedles', []) || []).join('\n');
            const regionHtml = this._renderRegionTiers();
            ...
            pane.innerHTML = `
              ...
              <div class="tem-section">
                ...
                <p>Self-reported location${useBio ? ' / bio' : ''} only. <strong>South Africa is never matched.</strong> Tier 1–2 on by default; Tier 3 optional.</p>
                <div class="tem-btns">
                  <button class="tem-btn tem-btn-ghost" id="tem-g-tier1" type="button">All Tier 1</button>
                  <button class="tem-btn tem-btn-ghost" id="tem-g-tier2" type="button">All Tier 2</button>
                </div>
                <div class="tem-btns">
                  <button class="tem-btn tem-btn-ghost" id="tem-g-tier3" type="button">All Tier 3</button>
                  <button class="tem-btn tem-btn-ghost" id="tem-g-tier-none" type="button">Clear all</button>
                </div>
                <div id="tem-g-regions">${regionHtml}</div>
                <div class="tem-btns">
                  <button class="tem-btn tem-btn-primary" id="tem-g-save-regions" type="button">Save regions</button>
                  <button class="tem-btn tem-btn-ghost" id="tem-g-reset-regions" type="button">Reset defaults</button>
                </div>
                <label class="tem-label" for="tem-g-custom">Extra custom needles (optional, one per line)</label>
                <textarea id="tem-g-custom" class="tem-input" rows="3" placeholder="optional extra place names">${Core.escapeHtml(customNeedles)}</textarea>
                <p class="tem-note" id="tem-g-region-count">Active needles: –</p>
              </div>
            ...
            UI.el('tem-g-save-regions').onclick = () => this.saveRegionSettings();
            UI.el('tem-g-reset-regions').onclick = () => {
                Core.store.set('geoRegions', this._defaultRegionState());
                Core.store.set('geoCustomNeedles', []);
                this.render();
                this.log('Regions reset to tier defaults');
            };
            UI.el('tem-g-tier1').onclick = () => this._setTierEnabled(1, true);
            UI.el('tem-g-tier2').onclick = () => this._setTierEnabled(2, true);
            UI.el('tem-g-tier3').onclick = () => this._setTierEnabled(3, true);
            UI.el('tem-g-tier-none').onclick = () => this._setTierEnabled(0, false);
            // Category master checkboxes toggle children
            const regionHost = UI.el('tem-g-regions');
            if (regionHost) {
                regionHost.querySelectorAll('input[data-indeterminate="1"]').forEach((cb) => {
                    cb.indeterminate = true;
                });
                regionHost.addEventListener('change', (e) => {
                    const t = e.target;
                    if (!t || t.type !== 'checkbox') return;
                    if (t.dataset.cat && !t.dataset.sub) {
                        const cat = t.dataset.cat;
                        const on = t.checked;
                        t.indeterminate = false;
                        regionHost.querySelectorAll('input[data-cat="' + cat + '"][data-sub]').forEach((cb) => {
                            cb.checked = on;
                        });
                    } else if (t.dataset.cat && t.dataset.sub) {
                        const cat = t.dataset.cat;
                        const subs = regionHost.querySelectorAll('input[data-cat="' + cat + '"][data-sub]');
                        const master = regionHost.querySelector('input[data-cat="' + cat + '"]:not([data-sub])');
                        if (master && subs.length) {
                            let n = 0;
                            subs.forEach((cb) => { if (cb.checked) n++; });
                            master.checked = n > 0;
        ...
        _defaultRegionState() {
            const state = {};
            for (let i = 0; i < this.regionCatalog.length; i++) {
                const cat = this.regionCatalog[i];
                state[cat.id] = !!cat.defaultOn;
                for (let j = 0; j < cat.subs.length; j++) {
                    const sub = cat.subs[j];
                    const subDef = sub.defaultOn !== undefined ? !!sub.defaultOn : !!cat.defaultOn;
                    state[cat.id + '.' + sub.id] = !!cat.defaultOn && subDef;
                }
            }
            return state;
        },
        ...
        _regionState() {
            const stored = Core.store.get('geoRegions', null);
            if (stored && typeof stored === 'object') {
                // Fill any new catalog keys with defaults
                const base = this._defaultRegionState();
                for (const k of Object.keys(base)) {
                    if (stored[k] === undefined) stored[k] = base[k];
                }
                return stored;
            }
            // Migrate legacy flat geoNeedles → enable Tier 1 only if present
            return this._defaultRegionState();
        },

        _renderRegionTiers() {
            const state = this._regionState();
            let lastTier = null;
            const parts = [];
            for (let i = 0; i < this.regionCatalog.length; i++) {
                const cat = this.regionCatalog[i];
                if (cat.tier !== lastTier) {
                    lastTier = cat.tier;
                    parts.push(
                        '<div class="tem-tier-label">Tier ' + cat.tier +
                        (cat.tier === 1 ? ' — Core (default on)' :
                            cat.tier === 2 ? ' — High volume (default on)' :
                                ' — Optional (default off)') + '</div>'
                    );
                }
                const catOn = !!state[cat.id];
                let subOn = 0;
                for (let j = 0; j < cat.subs.length; j++) {
                    if (state[cat.id + '.' + cat.subs[j].id]) subOn++;
                }
                const indeterminate = subOn > 0 && subOn < cat.subs.length;
                parts.push('<div class="tem-region-cat">');
                parts.push(
                    '<label class="tem-check tem-check-cat"><input type="checkbox" data-cat="' +
                    Core.escapeHtml(cat.id) + '"' + (catOn || subOn > 0 ? ' checked' : '') +
                    (indeterminate ? ' data-indeterminate="1"' : '') + '> <strong>' +
                    Core.escapeHtml(cat.label) + '</strong></label>'
                );
                parts.push('<div class="tem-region-subs">');
                for (let j = 0; j < cat.subs.length; j++) {
                    const sub = cat.subs[j];
                    const key = cat.id + '.' + sub.id;
                    const on = !!state[key];
                    parts.push(
                        '<label class="tem-check tem-check-sub"><input type="checkbox" data-cat="' +
                        Core.escapeHtml(cat.id) + '" data-sub="' + Core.escapeHtml(sub.id) + '"' +
                        (on ? ' checked' : '') + '> ' + Core.escapeHtml(sub.label) + '</label>'
                    );
                }
                parts.push('</div></div>');
            }
        ...
        _readRegionStateFromDom() {
            const host = UI.el('tem-g-regions');
            const state = this._defaultRegionState();
            if (!host) return state;
            // Reset all off then set from DOM
            ...
            host.querySelectorAll('input[type="checkbox"][data-cat]').forEach((cb) => {
                ...
                if (!cat) return;
                if (sub) state[cat + '.' + sub] = !!cb.checked;
                else state[cat] = !!cb.checked;
            });
            // Category on if any sub on
            for (let i = 0; i < this.regionCatalog.length; i++) {
                const cat = this.regionCatalog[i];
                let any = false;
                for (let j = 0; j < cat.subs.length; j++) {
                    if (state[cat.id + '.' + cat.subs[j].id]) any = true;
                }
                state[cat.id] = any;
            }
            return state;
        ...
        _setTierEnabled(tier, on) {
            ...
            for (let i = 0; i < this.regionCatalog.length; i++) {
                ...
                host.querySelectorAll('input[data-cat="' + cat.id + '"]').forEach((cb) => {
                    cb.checked = on;
                    cb.indeterminate = false;
                });
            }
        ...
        _paintRegionCount() {
            const el = UI.el('tem-g-region-count');
            if (!el) return;
            const live = UI.el('tem-g-regions')
                ? this._readRegionStateFromDom()
                : this._regionState();
            let n = 0;
            ...
            for (let i = 0; i < this.regionCatalog.length; i++) {
                ...
                for (let j = 0; j < cat.subs.length; j++) {
                    const sub = cat.subs[j];
                    if (!live[cat.id + '.' + sub.id]) continue;
                    n += (sub.needles || []).length;
                    (sub.scripts || []).forEach((s) => scripts.add(s));
                }
            }
            const customEl = UI.el('tem-g-custom');
            const custom = customEl
                ? this._parseLines(customEl.value)
                : (Core.store.get('geoCustomNeedles', []) || []);
            n += custom.length;
            el.textContent = 'Active needles: ' + n +
                (scripts.size ? ' · scripts: ' + [...scripts].join(', ') : '') +
                ' · South Africa excluded';
        },

        /**
         * @returns {{ needle: string, cat: string, sub: string, label: string }[]}
         */
        _activeNeedleEntries() {
            const state = this._regionState();
            const out = [];
            for (let i = 0; i < this.regionCatalog.length; i++) {
                const cat = this.regionCatalog[i];
                for (let j = 0; j < cat.subs.length; j++) {
                    const sub = cat.subs[j];
                    if (!state[cat.id + '.' + sub.id]) continue;
                    const needles = sub.needles || [];
                    for (let k = 0; k < needles.length; k++) {
                        out.push({
                            needle: String(needles[k]).toLowerCase(),
                            cat: cat.id,
                            sub: sub.id,
            ...
            const custom = Core.store.get('geoCustomNeedles', []) || [];
            for (let i = 0; i < custom.length; i++) {
                out.push({
                    needle: String(custom[i]).toLowerCase(),
                    cat: 'custom',
                    sub: 'custom',
                    label: 'Custom'
                });
        ...
        _isExcluded(hay) {
            ...
            for (let i = 0; i < this.regionExcludes.length; i++) {
                if (h.indexOf(this.regionExcludes[i]) !== -1) return true;
            }
            return false;
        },

        /**
         * Boundary-aware needle hit (reduces indiana→india false positives).
         */
        _needleHit(hay, needle) {
            const n = String(needle || '').toLowerCase();
            if (!n || !hay) return false;
            if (n === 'india') {
                // match india / indian but not indiana
                return /(?:^|[^a-z])india(?!na)(?:n\b|[^a-z]|$)/i.test(hay);
            }
            if (n === 'niger') {
                // not nigeria
                return /(?:^|[^a-z])niger(?:[^a-z]|$)/i.test(hay) && hay.indexOf('nigeria') === -1;
            }
            if (n === 'congo') {
                return /(?:^|[^a-z])congo(?:[^a-z]|$)/i.test(hay);
            }
        ...
        matchRegion(profile) {
            ...
            // Hard exclude South Africa etc. before any positive match
            if (this._isExcluded(hay)) {
                return { match: false, reason: null, reasonCode: null, reasonNeedle: null };
            }

            const entries = this._activeNeedleEntries();
            for (let i = 0; i < entries.length; i++) {
                const e = entries[i];
                if (!this._needleHit(hay, e.needle)) continue;
                const inLoc = this._needleHit(location, e.needle);
                return {
                    match: true,
                    reason: e.label + ' · "' + e.needle + '" in ' + (inLoc ? 'location' : 'bio'),
                    reasonCode: (e.cat + '.' + e.sub),
                    reasonNeedle: e.needle
                };
            }

            // Script signals only if corresponding subs enabled
            const scripts = this._activeScripts();
            if (scripts.has('devanagari') && /[\u0900-\u097F]/.test(profile.location || '')) {
                return {
                    match: true,
                    reason: 'Devanagari script in location',
                    reasonCode: 'script.devanagari',
                    reasonNeedle: null
                };
            }
